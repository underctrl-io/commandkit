...
### public clone(config?): [Context](/docs/classes/Context)\<T>
...
### public isMessage(): is | [Context](/docs/classes/Context)\<'message'>
...
### public locale(locale?): [Localization](/docs/classes/Localization)
