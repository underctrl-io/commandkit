...
| ----------- | ----------- | ----------- | ----------- |
| commandkit | [CommandKit](/next/api-reference/classes/CommandKit) | ❌ | The commandkit instance. |
...
### public getType(): [CommandKitEnvironmentType](/next/api-reference/enums/CommandKitEnvironmentType)
...
| Parameter | Type | Optional | Description |
| ----------- | ----------- | ----------- | ----------- |
| type | [CommandKitEnvironmentType](/next/api-reference/enums/CommandKitEnvironmentType) | ❌ | The environment type to set. |
