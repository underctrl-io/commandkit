...
| config | ContextParameters\<T> | ❌ | The context parameters. |
...
- [Source](https://github.com/underctrl-io/commandkit/blob/f8cc07d11d2ae5ed7f529adff1649936223e27b2/packages/commandkit/src/app/commands/Context.ts#L420)
...
- [Source](https://github.com/underctrl-io/commandkit/blob/f8cc07d11d2ae5ed7f529adff1649936223e27b2/packages/commandkit/src/app/commands/Context.ts#L427)
...
### public clone(config?): [Context](/next/api-reference/classes/Context)\<T>
...
| Parameter | Type | Optional | Description |
| ----------- | ----------- | ----------- | ----------- |
| fn | GenericFunction\<\[ | [CommandKitEnvironment](/next/api-reference/classes/CommandKitEnvironment) | ]> | ❌ | The function to defer. |
...
### public isMessage():  is | [Context](/next/api-reference/classes/Context)\<'message'>
...
### public locale(locale?): [Localization](/next/api-reference/classes/Localization)
