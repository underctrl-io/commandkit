...
<MemberInfo kind="method" type={`(handler: <a href='/docs/api-reference/commandkit/classes/app-command-handler#appcommandhandler'>AppCommandHandler</a>) => AppCommandRunner`}   />

Creates a new AppCommandRunner instance.
### runCommand

<MemberInfo kind="method" type={`(prepared: <a href='/docs/api-reference/commandkit/interfaces/prepared-app-command-execution#preparedappcommandexecution'>PreparedAppCommandExecution</a>, source: Interaction | Message, options?: <a href='/docs/api-reference/commandkit/interfaces/run-command-options#runcommandoptions'>RunCommandOptions</a>) => `}   />
...
<MemberInfo kind="method" type={`(source: Interaction | Message) => <a href='/docs/api-reference/commandkit/types/command-execution-mode#commandexecutionmode'>CommandExecutionMode</a>`}   />
