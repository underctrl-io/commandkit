...
<MemberInfo kind="method" type={`(handler: <a href='/docs/api-reference/commandkit/types/command-kit-button-builder-interaction-collector-dispatch#commandkitbuttonbuilderinteractioncollectordispatch'>CommandKitButtonBuilderInteractionCollectorDispatch</a>, data?: <a href='/docs/api-reference/commandkit/types/command-kit-button-builder-interaction-collector-dispatch-context-data#commandkitbuttonbuilderinteractioncollectordispatchcontextdata'>CommandKitButtonBuilderInteractionCollectorDispatchContextData</a>) => this`}   />
...
<MemberInfo kind="method" type={`(handler: <a href='/docs/api-reference/commandkit/types/command-kit-button-builder-on-end#commandkitbuttonbuilderonend'>CommandKitButtonBuilderOnEnd</a>) => this`}   />
...
<MemberInfo kind="method" type={`(predicate: <a href='/docs/api-reference/commandkit/types/button-kit-predicate#buttonkitpredicate'>ButtonKitPredicate</a>) => this`}   />
