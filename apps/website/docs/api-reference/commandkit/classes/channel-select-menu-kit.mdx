...
<MemberInfo kind="method" type={`(handler: <a href='/docs/api-reference/commandkit/types/command-kit-select-menu-builder-interaction-collector-dispatch#commandkitselectmenubuilderinteractioncollectordispatch'>CommandKitSelectMenuBuilderInteractionCollectorDispatch</a>&#60;       ChannelSelectMenuInteraction,       <a href='/docs/api-reference/commandkit/classes/channel-select-menu-kit#channelselectmenukit'>ChannelSelectMenuKit</a>     &#62;, data?: <a href='/docs/api-reference/commandkit/types/command-kit-select-menu-builder-interaction-collector-dispatch-context-data#commandkitselectmenubuilderinteractioncollectordispatchcontextdata'>CommandKitSelectMenuBuilderInteractionCollectorDispatchContextData</a>) => this`}   />
...
<MemberInfo kind="method" type={`(predicate: <a href='/docs/api-reference/commandkit/types/select-menu-kit-predicate#selectmenukitpredicate'>SelectMenuKitPredicate</a>&#60;ChannelSelectMenuInteraction&#62;) => this`}   />
