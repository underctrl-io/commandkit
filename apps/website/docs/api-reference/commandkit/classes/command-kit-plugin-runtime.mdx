...
<MemberInfo kind="method" type={`(commandkit: <a href='/docs/api-reference/commandkit/classes/command-kit#commandkit'>CommandKit</a>) => CommandKitPluginRuntime`}   />
...
<MemberInfo kind="method" type={`(pluginName: string) => <a href='/docs/api-reference/commandkit/classes/runtime-plugin#runtimeplugin'>RuntimePlugin</a> | null`}   />
...
<MemberInfo kind="method" type={`(plugin: <a href='/docs/api-reference/commandkit/classes/runtime-plugin#runtimeplugin'>RuntimePlugin</a>) => `}   />
...
<MemberInfo kind="method" type={`(f: <a href='/docs/api-reference/commandkit/types/async-function#asyncfunction'>AsyncFunction</a>&#60;[<a href='/docs/api-reference/commandkit/classes/command-kit-plugin-runtime#commandkitpluginruntime'>CommandKitPluginRuntime</a>, <a href='/docs/api-reference/commandkit/classes/runtime-plugin#runtimeplugin'>RuntimePlugin</a>], R | undefined&#62;) => `}   />
