...
<MemberInfo kind="method" type={`(event: Event, listener: (...args: ClientEvents[Event]) =&#62; void, options?: <a href='/docs/next/api-reference/commandkit/interfaces/event-interceptor-context-data#eventinterceptorcontextdata'>EventInterceptorContextData</a>&#60;Event&#62;) => () =&#62; void`}   />
