...
<MemberInfo kind="method" type={`(path: string | Buffer | URL | DatabaseSync, options: <a href='/docs/api-reference/commandkit/interfaces/kv-options#kvoptions'>KvOptions</a> = {
      enableWAL: true,
      namespace: 'commandkit_kv',
    }) => KV`}   />
...
<MemberInfo kind="method" type={`(key: string, operator: <a href='/docs/api-reference/commandkit/types/kv-math-operator#kvmathoperator'>KvMathOperator</a>, value: number | bigint) => number | bigint`}   />
...
<MemberInfo kind="method" type={`(namespace: string) => <a href='/docs/api-reference/commandkit/classes/kv#kv'>KV</a>`}   />
