...
<GenerationInfo sourceFile="packages/commandkit/src/app/commands/Context.ts" sourceLine="455" packageName="commandkit" />
...
```
* Extends: <code><a href='/docs/next/api-reference/commandkit/classes/context#context'>Context</a>&#60;T, <a href='/docs/next/api-reference/commandkit/interfaces/middleware-context-args#middlewarecontextargs'>MiddlewareContextArgs</a>&#62;</code>
