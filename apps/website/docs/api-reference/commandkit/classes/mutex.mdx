...
<MemberInfo kind="method" type={`(options: <a href='/docs/api-reference/commandkit/interfaces/mutex-options#mutexoptions'>MutexOptions</a> = {}) => Mutex`}   />

Creates a new mutex instance
### setStorage

<MemberInfo kind="method" type={`(storage: <a href='/docs/api-reference/commandkit/interfaces/mutex-storage#mutexstorage'>MutexStorage</a>) => `}   />

Sets the storage implementation for the mutex
### getStorage

<MemberInfo kind="method" type={`() => <a href='/docs/api-reference/commandkit/interfaces/mutex-storage#mutexstorage'>MutexStorage</a>`}   />
...
<MemberInfo kind="method" type={`() => Omit&#60;<a href='/docs/api-reference/commandkit/interfaces/mutex-options#mutexoptions'>MutexOptions</a>, 'storage'&#62;`}   />
