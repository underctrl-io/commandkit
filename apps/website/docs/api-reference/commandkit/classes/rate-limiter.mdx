...
<MemberInfo kind="method" type={`(maxRequests: number = DEFAULT_MAX_REQUESTS, interval: number = DEFAULT_TIMEOUT, storage: <a href='/docs/next/api-reference/commandkit/interfaces/rate-limit-storage#ratelimitstorage'>RateLimitStorage</a> = new MemoryRateLimitStorage()) => RateLimiter`}   />

Creates a new rate limiter instance
### setStorage

<MemberInfo kind="method" type={`(storage: <a href='/docs/next/api-reference/commandkit/interfaces/rate-limit-storage#ratelimitstorage'>RateLimitStorage</a>) => `}   />

Sets the storage implementation for the rate limiter
### getStorage

<MemberInfo kind="method" type={`() => <a href='/docs/next/api-reference/commandkit/interfaces/rate-limit-storage#ratelimitstorage'>RateLimitStorage</a>`}   />
...
<MemberInfo kind="method" type={`() => Omit&#60;<a href='/docs/next/api-reference/commandkit/interfaces/rate-limit-options#ratelimitoptions'>RateLimitOptions</a>, 'storage'&#62;`}   />
