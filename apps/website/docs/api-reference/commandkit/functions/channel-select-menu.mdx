...
<GenerationInfo sourceFile="packages/commandkit/src/components/v1/select-menu/SelectMenu.ts" sourceLine="296" packageName="commandkit" />
...
<MemberInfo kind="parameter" type={`<a href='/docs/next/api-reference/commandkit/interfaces/channel-select-menu-props#channelselectmenuprops'>ChannelSelectMenuProps</a>`} />
