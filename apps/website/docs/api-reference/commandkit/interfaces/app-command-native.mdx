...
<GenerationInfo sourceFile="packages/commandkit/src/app/handlers/AppCommandHandler.ts" sourceLine="36" packageName="commandkit" />
...
<MemberInfo kind="property" type={`SlashCommandBuilder | Record&#60;string, any&#62;`}   />
