...
<MemberInfo kind="property" type={`<a href='/docs/api-reference/commandkit/classes/button-kit#buttonkit'>ButtonKit</a>`}   />


### \[ElementType.Modal]

<MemberInfo kind="property" type={`<a href='/docs/api-reference/commandkit/classes/modal-kit#modalkit'>ModalKit</a>`}   />
