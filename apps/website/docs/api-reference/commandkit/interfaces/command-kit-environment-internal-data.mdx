...
<GenerationInfo sourceFile="packages/commandkit/src/context/environment.ts" sourceLine="10" packageName="commandkit" />
...
<MemberInfo kind="property" type={`<a href='/docs/api-reference/commandkit/enums/command-kit-environment-type#commandkitenvironmenttype'>CommandKitEnvironmentType</a> | null`}   />
...
<MemberInfo kind="property" type={`Map&#60;string, <a href='/docs/api-reference/commandkit/types/generic-function#genericfunction'>GenericFunction</a>&#60;[<a href='/docs/api-reference/commandkit/classes/command-kit-environment#commandkitenvironment'>CommandKitEnvironment</a>]&#62;&#62;`}   />
...
<MemberInfo kind="property" type={`<a href='/docs/api-reference/commandkit/classes/context#context'>Context</a> | null`}   />
