...
<GenerationInfo sourceFile="packages/commandkit/src/app/commands/Context.ts" sourceLine="49" packageName="commandkit" />
...
<MemberInfo kind="property" type={`<a href='/docs/api-reference/commandkit/classes/command-kit-environment#commandkitenvironment'>CommandKitEnvironment</a>`}   />
...
<MemberInfo kind="property" type={`T extends 'message' ? <a href='/docs/api-reference/commandkit/classes/message-command-parser#messagecommandparser'>MessageCommandParser</a> : never`}   />


### store

<MemberInfo kind="property" type={`Collection&#60;string, any&#62;`}   />
