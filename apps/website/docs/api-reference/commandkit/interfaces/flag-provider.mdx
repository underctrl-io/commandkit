...
<MemberInfo kind="method" type={`(key: string, context?: any) => MaybePromise&#60;<a href='/docs/api-reference/commandkit/interfaces/flag-configuration#flagconfiguration'>FlagConfiguration</a> | null&#62;`}   />
