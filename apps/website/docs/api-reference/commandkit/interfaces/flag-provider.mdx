...
<MemberInfo kind="method" type={`() => MaybePromise&#60;void&#62;`}   />

Initialize the provider (e.g., establish connections, load initial config)
### getFlag

<MemberInfo kind="method" type={`(key: string, context?: any) => MaybePromise&#60;<a href='/docs/next/api-reference/commandkit/interfaces/flag-configuration#flagconfiguration'>FlagConfiguration</a> | null&#62;`}   />

Get the current value/configuration for a feature flag
### hasFlag

<MemberInfo kind="method" type={`(key: string) => MaybePromise&#60;boolean&#62;`}   />
