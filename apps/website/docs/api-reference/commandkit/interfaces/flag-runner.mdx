...
<MemberInfo kind="method" type={`(context: <a href='/docs/api-reference/commandkit/types/custom-evaluation-context#customevaluationcontext'>CustomEvaluationContext</a>&#60;E&#62;) => Promise&#60;R&#62;`}   />
