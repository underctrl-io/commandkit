...
<MemberInfo kind="property" type={`E | <a href='/docs/api-reference/commandkit/types/custom-evaluation-function#customevaluationfunction'>CustomEvaluationFunction</a>&#60;E&#62;`}   />
