...
<GenerationInfo sourceFile="packages/i18n/src/i18n.ts" sourceLine="70" packageName="@commandkit/i18n" />
...
<MemberInfo kind="property" type={`<a href='/docs/next/api-reference/i18n/functions/i18n#i18n'>i18n</a>`}   />
