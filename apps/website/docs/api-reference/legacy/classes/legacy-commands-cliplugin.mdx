...
```
* Extends: <code><a href='/docs/api-reference/commandkit/classes/compiler-plugin#compilerplugin'>CompilerPlugin</a>&#60;<a href='/docs/api-reference/legacy/interfaces/legacy-handler-plugin-options#legacyhandlerpluginoptions'>LegacyHandlerPluginOptions</a>&#62;</code>
