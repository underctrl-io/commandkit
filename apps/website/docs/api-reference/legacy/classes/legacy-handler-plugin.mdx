...
<GenerationInfo sourceFile="packages/legacy/src/plugin.ts" sourceLine="32" packageName="@commandkit/legacy" />
...
```
* Extends: <code><a href='/docs/next/api-reference/commandkit/classes/runtime-plugin#runtimeplugin'>RuntimePlugin</a>&#60;<a href='/docs/next/api-reference/legacy/interfaces/legacy-handler-plugin-options#legacyhandlerpluginoptions'>LegacyHandlerPluginOptions</a>&#62;</code>
...
<MemberInfo kind="method" type={`(ctx: <a href='/docs/next/api-reference/commandkit/classes/command-kit-plugin-runtime#commandkitpluginruntime'>CommandKitPluginRuntime</a>, event: <a href='/docs/next/api-reference/commandkit/interfaces/command-kit-event-dispatch#commandkiteventdispatch'>CommandKitEventDispatch</a>) => Promise&#60;void&#62;`}   />
