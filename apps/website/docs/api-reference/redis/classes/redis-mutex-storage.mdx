...
```
* Implements: <code><a href='/docs/api-reference/commandkit/interfaces/mutex-storage#mutexstorage'>MutexStorage</a></code>
...
<MemberInfo kind="method" type={`(key: string) => Promise&#60;{     locked: boolean;     ttl: number;     value?: string;   }&#62;`}   />
