...
<MemberInfo kind="property" type={`<a href='/docs/api-reference/tasks/interfaces/task-driver#taskdriver'>TaskDriver</a> | null`}   />


### setDriver

<MemberInfo kind="method" type={`(driver: <a href='/docs/api-reference/tasks/interfaces/task-driver#taskdriver'>TaskDriver</a>) => void`}   />
...
<MemberInfo kind="method" type={`(task: <a href='/docs/api-reference/tasks/interfaces/task-data#taskdata'>TaskData</a>) => Promise&#60;string&#62;`}   />
...
<MemberInfo kind="method" type={`(runner: <a href='/docs/api-reference/tasks/types/task-runner#taskrunner'>TaskRunner</a>) => Promise&#60;void&#62;`}   />
