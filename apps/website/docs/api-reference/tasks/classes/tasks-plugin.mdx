...
```
* Extends: <code><a href='/docs/next/api-reference/commandkit/classes/runtime-plugin#runtimeplugin'>RuntimePlugin</a>&#60;<a href='/docs/next/api-reference/tasks/interfaces/tasks-plugin-options#taskspluginoptions'>TasksPluginOptions</a>&#62;</code>
