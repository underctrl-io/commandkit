...
:::tip
Chat input commands are just one of the type of commands that CommandKit supports. Learn more about [message commands](./04-message-commands.mdx) and [context menu commands](./03-context-menu-commands.mdx).
:::
