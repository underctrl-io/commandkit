...
description:
  Learn how to integrate CommandKit Queue with Discord.js using Redis
  PubSub.
---
...
the `@discordjs/brokers` package and Redis PubSub. This allows you to
send messages between different Discord.js shards or even different
...
First, you need a Redis instance running. You can use a local Redis
server or a cloud service like Redis Cloud.
