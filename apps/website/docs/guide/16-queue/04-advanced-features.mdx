...
description:
  Learn about custom drivers, error handling, and advanced queue
  features.
---

# Advanced Features

This guide covers advanced features of the CommandKit Queue system,
including custom drivers, error handling, and performance
optimizations.

## Custom Drivers

You can create custom drivers to work with any message queue backend.
A driver must implement the `MessageQueue` interface.
...
You now have a comprehensive understanding of CommandKit Queue's
